...
class AddIndicatorsBsmeai extends \CodeIgniter\Database\Migration {
        ...
        public function up()
        {
          $data = [
              ...
              [
                  'id' => 6,
                  'parameter_item' => 'S.5.1 Scientific Habit and thought',
                  'description' => 'S.5.1 Scientific Habit and thought ',
