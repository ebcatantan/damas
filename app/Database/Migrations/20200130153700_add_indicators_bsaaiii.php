...
class AddIndicatorsBsaaiii extends \CodeIgniter\Database\Migration {
        ...
        public function up()
        {
          $data = [
              ...
              [
                  ...
                  'document_needed_list' => '•	Copy of the program CMO
                                              •	Copy of the program curriculum (highlight the courses asked from the benchmark statement)
                                              •	Syllabi of the highlighted courses
                                              •	Matrix of courses that provides knowledge and theories on the field of specialization
                                              ',
                  'tagged_documents' => '[]',
                  'parameter_section_id' => '1',
                  'accreditation_template_id' => '3',
              ...
              [
                  ...
                  'document_needed_list' => '•	Policy on validation of courses taken from other schools (Highlight from the Student Handbook)
                                            •	BOR approval of the student handbook
                                            •	Forms used in validating courses
                                            •	Posted announcements regarding validation of subjects from other schools
                                            ',
                  'tagged_documents' => '[]',
                  'parameter_section_id' => '1',
                  'accreditation_template_id' => '3',
              ...
              [
                  ...
                  'document_needed_list' => '•	Matrix of program courses and objectives against the local, regional and national goals',
                  'tagged_documents' => '[]',
                  'parameter_section_id' => '1',
                  'accreditation_template_id' => '3',
                  'template_parameter_id' => '11',
