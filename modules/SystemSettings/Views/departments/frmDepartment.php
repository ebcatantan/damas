      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <input name="department_name" type="text" value="<?= isset($rec['department_name']) ? $rec['department_name'] : set_value('department_name') ?>" class="form-control <?= $errors['department_name'] ? 'is-invalid':'is-valid' ?>" id="department_name" placeholder="Deparment Name">
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <select name="dept_head_id" class="form-control <?= $errors['dept_head_id'] ? 'is-invalid':'is-valid' ?>">
