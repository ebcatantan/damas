      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <input name="doc_name" type="text" value="<?= isset($rec['doc_name']) ? $rec['doc_name'] : set_value('doc_name') ?>" class="form-control <?= $errors['doc_name'] ? 'is-invalid':'is-valid' ?>" id="doc_name" placeholder="Document Name">
              <?php if($errors['doc_name']): ?>
