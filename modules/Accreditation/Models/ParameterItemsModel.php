...
class ParameterItemsModel extends \CodeIgniter\Model
{
    ...
    protected $allowedFields = ['parameter_item', 'description', 'accreditation_template_id', 'document_needed_list', 'tagged_documents', 'parameter_section_id', 'template_parameter_id', 'parent_parameter_item_id', 'status', 'created_at','updated_at', 'deleted_at'];
