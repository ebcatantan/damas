...
class MSI extends BaseController
{
	//private $permissions;
	...
	public function __construct()
	{
	   ...
	   public function index($offset = 0)
	   {
	     ...
	     $data['offset'] = $offset;
			 ...
			 $data["item_parameters"] = $template_parameter_model->getDistictParametersInParameterItem(isset($data['ats'][0]['accreditation_template_id'])? $data['ats'][0]['accreditation_template_id'] : 0);
			 // echo "<pre>";
		 ...
		 public function displayItems($itemParameter, $accreditation_template_id){
			...
			// echo "<pre>";
			// print_r($data['parameter_sections']);
			// die();
 			// $program_model = new ProgramsModel;
