      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <input name="template_code" type="text" value="<?= isset($rec['template_code']) ? $rec['template_code'] : set_value('template_code') ?>" class="form-control <?= $errors['template_code'] ? 'is-invalid':'is-valid' ?>" id="template_code" placeholder="Accreditation Template Code">
              <?php if($errors['template_code']): ?>
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <input name="template_name" type="text" value="<?= isset($rec['template_name']) ? $rec['template_name'] : set_value('template_name') ?>" class="form-control <?= $errors['template_name'] ? 'is-invalid':'is-valid' ?>" id="template_name" placeholder="Accreditation Template Name">
              <?php if($errors['template_name']): ?>
                <div class="invalid-feedback">
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <textarea name="description" type="text" class="form-control <?= $errors['description'] ? 'is-invalid':'is-valid'  ?>" id="description" placeholder="Accreditation Template Description" rows="5"><?= isset($rec['description']) ? $rec['description'] : set_value('description') ?></textarea>
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="form-group">
            ...
            <select name="accreditation_level_id" class="form-control <?= $errors['accreditation_level_id'] ? 'is-invalid':'is-valid' ?>">
             ...
             <?php if($errors['accreditation_level_id']): ?>
                <div class="invalid-feedback">
